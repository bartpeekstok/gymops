...
export const GO = {
  ...
  hero: {
    ...
    routekaart: { label: 'Maak mijn routekaart', href: '/routekaart' },
  },
  ...
  trusted: [
    ...
    { name: 'CrossFit Kralingen', src: 'logo-cfk.png', scale: 1.35 },
    { name: 'Calisthenics Center Doetinchem', src: 'logo-ccd.png', scale: 1.35 },
    { name: 'CrossFit Lelystad', src: 'logo-cfls.png', scale: 1.35 },
    { name: 'CrossFit Gold Pact', src: 'logo-goldpact-w.png', scale: 1.35 },
    { name: 'CrossFit Primal', src: 'logo-primal.svg' },
  ],
  ...
  leden: {
    eyebrow: 'GymOps Flow · Ledenbehoud',
  ...
  cta: {
    ...
    primary: 'Plan een demo',
    routekaart: { label: 'Jouw routekaart naar 1 miljoen', href: '/routekaart' },
  },

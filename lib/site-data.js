...
export const GO = {
  ...
  nav: [
    ...
    { label: 'Leden', href: 'ledenbehoud.html' },
    { label: 'Team', href: 'team-aansturing.html' },
    { label: 'Mentorschap', href: 'mentorschap.html' },
    { label: 'Prijzen', href: 'prijzen.html' },
    { label: 'Over ons', href: 'over-ons.html' },
  ],

  hero: {
    eyebrow: 'Hét alles-in-één systeem voor gym owners',
    headline: ['Elke lead opgevolgd.', 'Elk lid gezien.', 'Elke taak gedaan.'],
    sub: 'Alles voor leadopvolging, ledenbehoud en team-aansturing op één plek, naadloos gekoppeld aan SportBit.\n\nGebouwd voor en door gym-owners.',
    primary: 'Plan een demo',
  },

  trusted: [
    { name: 'Unscared', src: 'logo-unscared.png' },
    { name: 'CrossFit Primal', src: 'logo-primal.png' },
    { name: 'CrossFit Gold Pact', src: 'logo-goldpact-w.png', scale: 1.35 },
    ...
    { name: 'CrossFit Kralingen', src: 'logo-cfk-lijn.png', scale: 1.35 },
    { name: 'CrossFit Lelystad', src: 'logo-cfls.png', scale: 1.35 },
],
  ...
  leden: {
    ...
    items: [
      ...
      { icon: 'route', title: 'Een klantreis die leden bindt', body: 'Van eerste les tot trouw lid: GymOps seint je op het juiste moment in, zodat jij of je coaches persoonlijk contact opnemen. Geen automatische mail- of WhatsApp-stroom, maar een echt gesprek waardoor ieder lid zich gezien voelt en langer blijft.' },
  ...
  testimonials: [
    ...
    { quote: 'Mijn coaches werken eindelijk consistent. Iedereen weet wat er moet gebeuren.', name: 'Bart Peekstok', company: 'CrossFit Alkmaar', initials: 'BP', metric: 'Team op één lijn' },
    { quote: 'Twee maanden na de start al 8 nieuwe leden direct uit de automatisering.', name: 'Kees Houwaart', company: 'Gymbox Noordwijk', initials: 'KH' },
    { quote: 'Niemand voelt zich meer vergeten en onze leden blijven merkbaar langer.', name: 'Hannah C.', company: 'Unscared', initials: 'HC', metric: 'Geen lid vergeten' },
...
export const GOP = {
  ...
  producten: {
    ...
    pillars: [
      {
        ...
        body: 'GymOps neemt over wat jou weghoudt van je leden. Van leadgeneratie tot persoonlijke kaartjes, van event-pagina\u2019s tot Google reviews. Flow handelt het op het juiste moment voor je af.',
        features: [
          'Custom website (SEO + AI search)',
          'Leadcapture & opvolging via WhatsApp en e-mail',
          'Handgeschreven kaarten via app of laptop',
    ...
    everything: [
      ...
      {
        icon: 'heart', title: 'Geen lid meer vergeten', href: 'ledenbehoud.html',
  ...
  prijzen: {
    ...
    plans: [
      {
        productLabel: 'GymOps', status: 'Beschikbaar', highlighted: true,
        name: 'Alles inbegrepen', price: '\u20ac450', period: '/ maand',
        ...
        featureGroups: [
          ...
          },
          {
            ...
            items: [
              { icon: 'phone-call', text: '4 onboarding-calls' },
    ...
    onboarding: {
      ...
      sub: '4 begeleide calls en wij richten alles in. Jij hoeft alleen je gym te runnen.',
      steps: [
        ...
        { n: '3', title: 'Week 3 \u00b7 Training', body: 'We trainen je team, finetunen je flows en lopen alles samen door.' },
        { n: 'check', title: 'Week 4 \u00b7 Live', body: 'Alles draait. Elke lead opgevolgd, elk lid gezien, elke taak toegewezen.' },
      ],
    },
    faqTitle: 'Veelgestelde vragen',
    faqs: [
      { q: 'Wat kost GymOps en wat is er inbegrepen?', a: 'GymOps kost \u20ac450 per maand (excl. btw). Bij jaarbetaling betaal je 11 maanden (\u20ac4.950) en is de 12e gratis.' },
      ...
      { q: 'Wie bouwt mijn website en wat als ik iets wil aanpassen?', a: 'Wij bouwen je website op maat in dezelfde technologie als bedrijven als Netflix en Spotify. Geen WordPress-thema of page builder. Nieuwe abonnementsvorm, tariefswijziging of een nieuwe coach in het team? Dat pas je zelf aan vanuit je GymOps-dashboard en het staat direct live. Geen wachttijd, geen offertes. Liever dat wij het doen, of gaat het om een grotere wijziging? Ook dat is inbegrepen.' },
      { q: 'Hoe weten jullie wat werkt voor mijn gym?', a: 'Op twee manieren. We runnen zelf gyms die volledig op GymOps draaien, dus elke flow en elk bericht testen we eerst bij onszelf. En omdat alle GymOps-gyms op hetzelfde systeem draaien, zien we over die gyms heen welke opvolging, welke timing en welke teksten het beste werken en welke niet. Wat zich bewijst, verwerken we in de standaardflows die jij krijgt. Je hoeft dus niet zelf uit te vinden wat werkt. We kijken daarbij naar geaggregeerde patronen; ledengegevens delen we nooit tussen gyms.' },
      { q: 'Hoe lang duurt de onboarding?', a: 'De meeste gyms zijn binnen vier weken live. De onboarding bestaat uit 4 begeleide calls. We importeren je bestaande ledendata, richten je customer journeys in en koppelen SportBit zodat alles vanaf dag \u00e9\u00e9n werkt.' },
  ...
  klanten: {
    ...
    trusted: [
      { name: 'Unscared', src: 'logo-unscared.png' },
      { name: 'CrossFit Primal', src: 'logo-primal.png' },
      { name: 'CrossFit Gold Pact', src: 'logo-goldpact.png', scale: 1.35 },
      { name: 'CrossFit Alkmaar', src: 'logo-cfa.png' },
      { name: 'CrossFit Naarden', src: 'logo-cfn.png' },
      { name: 'CrossFit Capelle', src: 'logo-cfc.png' },
      { name: 'CrossFit Leiden', src: 'logo-cfl.png' },
      { name: 'Gymbox Noordwijk', src: 'logo-gymbox.png' },
      { name: 'CrossFit TX', src: 'logo-cftx.png' },
      { name: 'CrossFit Willemsoord', src: 'logo-willemsoord-2.png' },
      { name: 'CrossFit Kralingen', src: 'logo-cfk-kleur.png', scale: 1.35 },
      { name: 'CrossFit Lelystad', src: 'logo-cfls.png', scale: 1.35 },
],
  },
  ...
  overons: {
    ...
    founders: [
      ...
      },
      {
        ...
        gym: 'logo-cfa.png',
        bio: 'Ik weet hoe een gym werkt, want ik sta er zelf al meer dan 12 jaar middenin. Leads die er tussenuit glippen, opvolging die blijft liggen, een klantreis die nergens op papier staat en taken die niet worden opgepakt. Ik heb het allemaal jarenlang werkbaar geprobeerd te maken, terwijl ik alle andere ballen ook in de lucht hield.\n\nOp zoek naar een oplossing heb ik meerdere CRM systemen voor sportscholen gebruikt, zowel Nederlandse als Amerikaanse. Geen \u00e9\u00e9n was echt ingericht voor kleinere coaching gyms of de Nederlandse markt. Toen Jeroen en ik hierover begonnen te sparren, was het idee van GymOps al gauw ontstaan!\n\nBij CrossFit Alkmaar zijn we altijd goed geweest in persoonlijk, oprecht contact. Ook met meer leden lukt het ons nog goed om iemand n\u00e9t op het goede moment een berichtje te sturen of een kaartje om iets te vieren. Het systeem zorgt ervoor dat we niemand vergeten, onze teksten en cadeautjes zijn nog steeds oprecht en persoonlijk.\n\nGymOps regelt je hele leadflow en klantreis automatisch, van het eerste contactmoment tot de viering van de 100e workout. In het Nederlands, afgestemd op hoe jouw gym \u00e9cht werkt, en met mensen bereikbaar die je begrijpen.\n\nDit is wat ik zelf tien jaar geleden al had willen hebben. Ik vind het nu zo gaaf om te zien dat GymOps ook andere gyms helpt!',
      },
    ],
    ...
    why: [
      ...
      { icon: 'zap', title: 'Zelf aanpassen, direct live', body: 'Nieuwe abonnementsvorm? Tariefswijziging? Een nieuwe coach in het team? Je past je website zelf aan vanuit je GymOps-dashboard en het staat meteen live. Geen weken wachten, geen offertes.' },
      ...
      { icon: 'chart-line', wide: true, title: 'We zien wat werkt, bij ons én bij alle gyms', body: 'We draaien GymOps zelf in onze eigen gyms, dus elke flow wordt daar eerst getest voordat jij hem krijgt. Daarnaast zien we over alle aangesloten gyms heen welke berichten, welke momenten en welke flows het beste werken en welke niet. Wat zich bewijst, wordt standaard voor iedereen. Het gaat daarbij om geaggregeerde patronen; ledengegevens delen we nooit tussen gyms.' },
    ],
  },
};

...
export const GO = {
  ...
  hero: {
    ...
    sub: 'Alles voor leadopvolging, ledenbehoud en team-aansturing op één plek. Werkt met en zonder SportBit.\n\nGebouwd voor en door gym-owners.',
  ...
  trusted: [
    ...
    { name: 'CrossFit Haarlem', src: 'logo-cfh-w.png' },
],
...
export const GOP = {
  ...
  klanten: {
    ...
    trusted: [
      ...
      { name: 'CrossFit Lelystad', src: 'logo-cfls.png', scale: 1.35 },
      { name: 'CrossFit Haarlem', src: 'logo-cfh.png' },
],
  },

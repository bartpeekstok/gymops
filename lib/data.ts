...
export const pricingPlans = [
  {
    ...
    features: [
      ...
      "Toegang tot GymOps Academy (we leren je alles uit het systeem te halen)",
...
export const founders = [
  ...
  {
    initials: "BP",
    photo: "/bart-peekstok.webp",
    name: "Bart Peekstok",
    role: "Mede-oprichter GymOps · Eigenaar CrossFit Alkmaar",
    bio: "Ik weet hoe een gym werkt, want ik sta er zelf al meer dan 12 jaar middenin. Leads die er tussenuit glippen, opvolging die blijft liggen, een klantreis die nergens op papier staat en taken die niet worden opgepakt of vergeten. Ik heb het allemaal jarenlang werkbaar geprobeerd te maken, terwijl ik alle andere ballen als gym-eigenaar ook nog in de lucht aan het houden was. Precies daarom hebben we GymOps gebouwd.\n\nBij CrossFit Alkmaar zijn we altijd goed geweest in persoonlijk contact. Ook met meer leden lukt het ons nog goed om iemand nét op het goede moment een berichtje te sturen of een ansichtkaartje om iets te vieren. Al ons contact is nog steeds persoonlijk en oprecht, het systeem zorgt ervoor dat we niemand vergeten.\n\nGymOps regelt je hele leadflow en klantreis automatisch, van het eerste contactmoment tot de viering van de 100e workout. In het Nederlands, afgestemd op hoe jouw gym écht werkt, en met mensen bereikbaar die je begrijpen omdat we hetzelfde pad hebben gelopen.\n\nDit is wat ik zelf tien jaar geleden al had willen hebben.",
    history: "",
  },
];
...
export const productPillars = [
  ...
  },
  {
    icon: "users",
    tag: "Binnenkort",
    productName: "GymOps Pulse",
    tagline: "Voor je team: Staff App + Management Dashboard",
    body: "Pulse breidt Flow uit met tools voor je team. Coaches gebruiken de Staff App, eigenaren krijgen overzicht via het Management Dashboard. Bestaande Flow-klanten upgraden zonder setupkosten.",
    features: [
      "Pulse Staff App",
      "Management Dashboard",
      "Onbeperkt medewerkers",
      "Incidentregistratie met audit-trail",
    ],
    cta: "Houd me op de hoogte",
    comingSoon: true,
  },
